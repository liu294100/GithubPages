define(function(require, exports, module) {
    ...
    exports.create = function(object) {
        ...
        if(type=="dropdown"){
            ...
            var html='<div class="dropdown pull-right" style="padding:1px;"><a class="btn-1ke-circle dropdown-toggle"  href="javascript:" id="dropdownMenu1" data-toggle="dropdown" > <i class="fa fa-share-square-o"></i> </a><br/><ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1"><div class="bdsharebuttonbox" style="padding:1px;">';
        }else{
        ...
        if(bdBottom){
              ...
              var html='<div class="dropdown pull-top" style="padding:1px;"><a class="fa fa-share-square-o"  href="javascript:" id="dropdownMenu1" data-toggle="dropdown" ></a><br/><ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1"><div class="bdsharebuttonbox" style="padding:1px;">';
        }
